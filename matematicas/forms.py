...
class FormMath(forms.ModelForm):
	...
	class Meta:
		...
		labels = {
			...
			'Matematicas1': '1. ¿Que son los números naturales?',
			'Matematicas2': '2. ¿Que son los números enteros?',
			'Matematicas3': '3. √432',
			'Matematicas4': '4. 2918838/897',
			'Matematicas5': '5. (45/26)*(39/25)*(22/33)',
